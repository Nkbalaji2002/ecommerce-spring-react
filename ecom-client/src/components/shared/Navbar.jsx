    ...
    <>
      <div className="h-17.5 bg-custom-gradient z-50 text-white flex items-center sticky top-0">
        <div className="lg:px-14 sm:px-8 px-4 w-full flex justify-between">
          ...
          <ul
            className={`flex sm:gap-10 gap-4 sm:items-center text-slate-800 sm:static absolute left-0 top-17.5*
          ...
          <>
            <button
              className="sm:hidden flex items-center sm:mt-0 mt-2 z-60"
