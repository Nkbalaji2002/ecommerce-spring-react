  ...
  return (
    <>
      <div
        ...
        style={{
          backgroundImage:
            "url('https://images.pexels.com/photos/5614283/pexels-photo-5614283.jpeg')",
        }}
      >
              ...
              <>
                <div className="flex flex-col items-center space-y-2 mt-4">
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-600">+9145564254787</span>
                  </div>

                  <div className="flex items-center">
                    <FaEnvelope className="text-blue-500 mr-2" />
                    <span className="text-gray-600">eshop@example.com</span>
                  </div>
