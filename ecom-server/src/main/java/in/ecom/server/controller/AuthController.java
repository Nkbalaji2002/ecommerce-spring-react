...
public class AuthController {
    ...
    @Operation(summary = "Already Account there Sign-in Account")
    @PostMapping("sign-in")
    ...
    @Tag(name = "User APIs", description = "APIs for Managing User")
    @Operation(summary = "If new User Create New Account to Register")
    @PostMapping("sign-up")
    ...
    @Tag(name = "User APIs", description = "APIs for Managing User")
    @Operation(summary = "Get the User Name")
    @GetMapping("username")
